...
import majorpull.com.majorpull.user.Interface.RatingListener;


/**
 * Created by nine-hertz on 23/1/18.
 */

public class ProperRatingBar extends LinearLayout {

        private static final int DF_TOTAL_TICKS = 6;
        ...
        private void addDrawableTick(Context context, int position) {
            ...
            System.out.println("upating tick-- " + position);
        ...
        private void updateTicksClickParameters(View tick, int position) {
            if (clickable) {
                tick.setTag(R.id.prb_child_tag_id, position);
        ...
        private OnClickListener mTickClickedListener = new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("tick selected-- " + "yes i ");
                redrawTicks();
        ...
        private void redrawTicks() {
            iterateTicks(new TicksIterator() {
                ...
                public void onTick(View tick, int position) {
                    ...
                    if (useSymbolicTick) {
                        System.out.println("tick selected-- " + "yes i ma here");
                        redrawTickSelection((TextView) tick,
                                position <= lastSelectedTickIndex);
                    } else {
                        System.out.println("tick selected-- " + "yes i not here");
        ...
        private void redrawTickSelection(ImageView tick, boolean isSelected) {
            ...
            System.out.println("tick selected-- " + isSelected);
            if (isSelected) {
